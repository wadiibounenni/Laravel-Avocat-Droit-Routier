...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Ajouter un Article  </h4><br><br>
            @if ($errors->any())
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Contenu de l'Article </label>
                <div class="col-sm-10">
           ...
           <input name="image_article" class="form-control" type="file" id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
  <img id="showImage" class="rounded avatar-lg" src="{{ old('image_article') ? url(old('image_article')) : url('upload/no_image.jpg') }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="tags" class="form-control" type="text" data-role="tagsinput" value="{{ old('titre') }}">
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Ajouter un Article">
            </form>
