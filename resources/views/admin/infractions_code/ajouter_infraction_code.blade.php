...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Ajouter une Infraction au Code de la Route  </h4><br><br>
            @if ($errors->any())
            ...
            <form method="post" action="{{route('store.infraction.code')}}" enctype="multipart/form-data">
                @csrf
           ...
           <input name="image_infraction" class="form-control" type="file" id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
  <img id="showImage" class="rounded avatar-lg" src="{{ old('image_infraction') ? url(old('image_infraction')) : url('upload/no_image.jpg') }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
            <br><br>
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Ajouter une Infraction">
            </form>
