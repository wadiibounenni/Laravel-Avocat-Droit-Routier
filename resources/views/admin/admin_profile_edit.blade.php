...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Editer la Page du Profil </h4>

            <form method="post" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                @csrf

            <div class="row mb-3">
            <label for="example-text-input" class="col-sm-2 col-form-label" style="color: blue">Nom et Prénom</label>
                <div class="col-sm-10">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label" style="color: blue">Email</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label" style="color: blue">Image du Profil</label>
                <div class="col-sm-10">
